...
function Maincharacters() {
  ...
  const [nextButtonClickedCharacter, setNextButtonClickedCharacter] = useState(false);
    ...
    if (id) {
      axios.get(`http://10.16.16.108:7000/api/editbook/${id}`)
        .then((response) => {
          ...
          dispatch(updateCreateNewBookField({ field: 'characterName', value: response.data.characterName }));
          dispatch(updateCreateNewBookField({ field: 'Role', value: response.data.Role }));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Character data submitted successfully:', response.data);
  ...
  return (
    <>
                  ...
                  >
                    <Col md="6">
                      ...
                      <Form.Control
                        ...
                        name="characterName"
                        value={id ? characterData.characterName : formData.characterName}
                        onChange={handleChange}
                        isInvalid={!!validationErrors.characterName}
                      />
                      <Form.Control.Feedback type="invalid"> {validationErrors.characterName}</Form.Control.Feedback>
                  ...
                  >
                    <Col md="12">
                      ...
                      <Form.Control
                        ...
                        rows={3}
                        name="Description"
                        value={id ? characterData.Description : formData.Description}
                        onChange={handleChange}
                        required
      ...
      {/* {nextButtonClicked && <Setting formData={formData} bookData={bookData} />} */}
      {/* {console.log("nextButtonClickedCharacter:", nextButtonClickedCharacter)}
      {nextButtonClickedCharacter && <Setting Maincharacters={formData} bookData={bookData} />} */}
    </>
  );
}
