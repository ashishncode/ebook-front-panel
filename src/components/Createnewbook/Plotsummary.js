    ...
    if (id) {
      axios.get(`http://10.16.16.108:7000/api/editbook/${id}`)
        .then((response) => {
          ...
          dispatch(updateCreateNewBookField({ field: 'plotSummary', value: response.data.plotSummary }));
                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  >
                    <Col md="12">
                      ...
                      />
                      <Form.Control.Feedback type="invalid"> {validationErrors.plotSummary}</Form.Control.Feedback>
                    </Col>
                  </Row>
                  <Row >
