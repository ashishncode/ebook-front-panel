...
function CreatenewbookUpdate() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post(`http://10.16.16.108:7000/api/updatebook/${_id}`, bookData); // Replace `bookId` with the actual book ID
                                ...
                                <Form onSubmit={handleSubmit}>
                                    ...
                                    >
                                        <Form.Check
                                            ...
                                            onChange={(e) => setBookData({ ...bookData, chapterIntroductions: e.target.checked })}
                                        />
                                    </Form.Group>
                                    <Form.Group
                                        className={`mb-12 ${createnewbookStyle.book_details_introductions}`}
                                    >
                                        <Form.Check
                                            ...
                                            onChange={(e) => setBookData({ ...bookData, chapterConclusions: e.target.checked })}
