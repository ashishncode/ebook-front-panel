...
import { ResetAuthorPassword } from "../../utility/api";

const ResetPasswordAuthor = ({ match }) => {
  ...
  const handlePasswordReset = async (e) => {
    ...
    try {
      if (isPasswordValid && isConfirmPasswordValid) {
        ...
        ResetAuthorPassword(token, data).then((response) => {
...
export default ResetPasswordAuthor;
